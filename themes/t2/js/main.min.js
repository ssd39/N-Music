var AudioHandler = function () {
      ...
      function i(audioURL) {
         A = new Audio,A.setAttribute("crossorigin", "anonymous"), A.setAttribute("src", audioURL) ,A.setAttribute("controls", "controls"), A.setAttribute("preload", "auto"), A.addEventListener("seeked", o, !0), A.loop = !0, $(A).addClass("audio-elem"), $(A).insertAfter("#controls-header"), $("#preloader").hide(), P = V.createMediaElementSource(A), P.connect(U), P.connect(D), Q = !0, A.play(), BPMHandler.onBPMBeat(), l()
      }
      ...
      var E, y, z, b, S, R, w, C, P,mycallBack, M, V, U, D, A, F, B, I = {
            gain: .9,
            beatHoldTime: 50,
            beatThreshold: .05,
            beatDecayRate: .97,
   ...
   UberVizMain = function () {
      function e() {
         return d = !!("ontouchstart" in window), window.location.href.indexOf("mobile") > -1 && (d = !0), console.log("n-music v" + VERSION), a("n-music v" + VERSION), $(window).on("resize", i), r() ? (navigator.getUserMedia = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia, navigator.getUserMedia ? (document.onselectstart = function () {
            return !1
